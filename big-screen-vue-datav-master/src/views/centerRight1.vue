    ...
    <div class="bg-color-black">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          ...
          <a v-on:click='oilClick' href="javascript:void(0)" @click="changeEnergyType(1)"><span style="color: #007bff;">油车</span></a>
          <a v-on:click='electricClick' href="javascript:void(0)" @click="changeEnergyType(2)"><span style="color: #33cea0;">电车</span></a>
        </div>
      </div>
