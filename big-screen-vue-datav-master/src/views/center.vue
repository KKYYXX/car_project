<template>
  <div id="center">
    <div class="up">
      ...
      >
        <p style="color:#00a8ff;font-weight:bold;font-size:16px;">车辆总数据</p>
      ...
      <div
        class="bg-color-black item"
      >
        <p style="color:#00a8ff;font-weight:bold;font-size:16px;">销售最多汽车</p>
        <div style="text-align:center;line-height:2">
          {{this.result.topCar}}
        </div>
      </div>
      <div
        class="bg-color-black item"
      >
        <p style="color:#00a8ff;font-weight:bold;font-size:16px;">车辆最高销售额</p>
        <div style="text-align:center;line-height:2">
      ...
      <div
        class="bg-color-black item"
      >
        <p style="color:#00a8ff;font-weight:bold;font-size:16px;">销售最多车型</p>
        <div style="text-align:center;line-height:2">
      ...
      <div
        class="bg-color-black item"
      >
        <p style="color:#00a8ff;font-weight:bold;font-size:16px;">车型最多品牌</p>
        <div style="text-align:center;line-height:2">
      ...
      <div
        class="bg-color-black item"
      >
        <p style="color:#00a8ff;font-weight:bold;font-size:16px;">车辆平均价格</p>
        <div style="text-align:center;line-height:2">
    ...
    <div class="down">
      <div class="ranking bg-color-black">
        ...
        <span style="color:#007bff;font-weight:bold;font-size:18px;">汽车品牌榜</span>
